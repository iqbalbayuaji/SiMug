...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden ">
            ...
            <div className="absolute lg:-left-48 lg:top-200 lg:-translate-y-50 -left-48 top-100 translate-y-50 w-70 h-30 lg:w-100 lg:h-100 rounded-full bg-blue-500 blur-3xl lg:blur-3xl lg:opacity-100 opacity-70" />
            <div className="absolute lg:-left-48 lg:top-200 lg:-translate-y-50 -left-48 top-100 translate-y-50 w-70 h-50 lg:w-80 lg:h-80 rounded-full bg-blue-500 blur-xl lg:blur-xl lg:opacity-70 opacity-50" />

            <div className="absolute lg:top-160 top-170 left-1/2 -translate-x-1/2 w-320 h-70 rounded-full bg-blue-500 blur-3xl opacity-40" />

            <div className="absolute lg:-right-48 lg:top-200 lg:-translate-y-50 -right-48 top-100 translate-y-50 w-70 h-30 lg:w-100 lg:h-100 rounded-full bg-blue-500 blur-3xl lg:blur-3xl lg:opacity-100 opacity-70" />
            <div className="absolute lg:-right-48 lg:top-200 lg:-translate-y-50 -right-48 top-100 translate-y-50 w-70 h-50 lg:w-80 lg:h-80 rounded-full bg-blue-500 blur-xl lg:blur-xl lg:opacity-70 opacity-50" />
            {/* Navigation Bar */}
