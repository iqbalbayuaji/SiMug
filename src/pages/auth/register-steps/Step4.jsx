      ...
      <div className="w-full lg:w-[65%] flex flex-col px-6 sm:px-10 md:px-16 lg:px-20 py-4 md:py-8 lg:py-10 overflow-y-auto">
          ...
          {methods.map((method) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`w-6 h-6 rounded-full border-3 flex items-center justify-center flex-shrink-0 mt-0.5 transition-all ${selectedMethod === method.id
                  ? "border-[#4177FF]"
                  : "border-[#4177FF]"
                  }`}>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
          ...
          <button
            ...
            className={`px-8 py-3 rounded-full font-semibold transition-all duration-300 ${selectedMethod
