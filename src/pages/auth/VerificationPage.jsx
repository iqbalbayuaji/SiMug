  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#F8FAFF] to-white flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      <button
        ...
        className={`fixed top-6 right-6 z-50 p-3 rounded-full shadow-lg transition-all duration-300 ${audioBlocked
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <div className="flex justify-center mb-16">
          <button
            ...
            className={`px-8 py-3 rounded-full font-semibold transition-all duration-300 flex items-center gap-2 ${progress >= 100
        ...
        <div className="max-w-xl mx-auto">
          <div className="relative h-[180px]">
            {tips.map((tip, index) => (
              <div
                key={index}
                className={`absolute inset-0 transition-opacity duration-700 ${index === currentTip ? 'opacity-100' : 'opacity-0'
                  }`}
              >
