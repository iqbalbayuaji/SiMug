                  ...
                  <div>
                    {course.discountPrice ? (
                      <>
                        ...
                        <p className="text-xl sm:text-2xl font-bold text-[#4177FF]">Rp {course.discountPrice.toLocaleString('id-ID')}</p>
                      </>
                    ) : (
                      <p className="text-xl sm:text-2xl font-bold text-[#4177FF]">Rp {course.price.toLocaleString('id-ID')}</p>
                    )}
                  </div>
