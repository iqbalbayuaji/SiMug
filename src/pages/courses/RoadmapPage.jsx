    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="flex-1 bg-white py-6 sm:py-8">
        <div className="w-full px-4 sm:px-6">
          ...
          <div className="md:hidden space-y-8 px-2 relative">
            ...
            {phases.map((phase, index) => (
              <div key={phase.id} className="relative pl-10">
                {/* Timeline Dot */}
                <div className={`absolute -left-1.5 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full border-4 border-white flex items-center justify-center z-10 ${phase.status === 'completed' || phase.status === 'current'
                  ? 'bg-[#4177FF]'
                  : 'bg-gray-300'
                  }`}>
                ...
                <div
                  ...
                  className={`bg-white rounded-2xl p-3 shadow-md border-2 ${phase.status === 'current'
                    ? 'border-[#4177FF]'
                    : phase.status === 'completed'
                      ? 'border-green-400'
                      : 'border-gray-200'
          ...
          {/* Navigation Buttons */}
          <div className="max-w-7xl mx-auto flex flex-col-reverse sm:flex-row items-center justify-between gap-4 mt-4 lg:mt-8">
            <button
              onClick={() => navigate(-1)}
              className="cursor-pointer hidden lg:flex px-6 py-3 bg-white text-gray-700 font-semibold rounded-full border border-gray-200 hover:bg-gray-200 hover:border-gray-300 transition-colors shadow-sm flex items-center gap-2 duration-250"
            >
            ...
            <div className="lg:flex items-center gap-4">
              ...
              <div className="hidden lg:flex gap-4">
                <button
                  onClick={handlePrevious}
                  disabled={currentIndex === 0}
                  className="cursor-pointer w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <svg className="w-6 h-6 text-[#4177FF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
                  </svg>
              ...
              <button
                ...
                className="cursor-pointer mt-4 lg:mt-0 bg-[#4177FF] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#3461D9] transition-colors shadow-lg flex items-center gap-2"
              >
