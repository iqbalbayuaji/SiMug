...
export default function InstructorTab({ course }) {
    return (
        <div className="p-8 md:p-10">
            ...
            {/* Instructor Card */}
            <div className="bg-gradient-to-br from-blue-50 via-white to-blue-50 rounded-3xl p-8 border border-[#4177ff]/20">
                <div className="flex flex-col md:flex-row gap-8">
                    <div className="flex-shrink-0 text-center md:text-left">
                        <div className="relative inline-block">
                            <div className="absolute -inset-2 bg-gradient-to-r from-[#4177ff] to-blue-600 rounded-3xl blur-lg opacity-40"></div>
                            <img
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-[#4177ff] font-semibold mb-6">{course.instructor.title}</p>
                        ...
                        <div className="grid grid-cols-3 gap-4 mb-6">
                            ...
                            <div className="bg-white rounded-2xl p-4 text-center shadow-sm border border-gray-100">
                                <div className="flex items-center justify-center gap-1 text-[#4177ff] mb-1">
                                    <FaUsers />
