  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Daftar Kursus Kamu <span className="text-sm sm:text-base font-semibold ml-4 text-gray-500">{courses.length} total kursus</span></h2>
        </div>
        
        <div className="flex items-center gap-2 sm:gap-3 w-full lg:w-auto">
          {/* Search Bar with Button */}
          <div className="relative flex-1 min-w-0">
            <div className="flex items-center bg-white border-2 border-gray-300 rounded-full overflow-hidden w-full">
              <svg 
                className="w-6 h-6 text-gray-400 ml-3 sm:ml-5 shrink-0" 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
              ...
              <input
                ...
                className="flex-1 px-3 sm:px-4 py-2 sm:py-3 focus:outline-none text-gray-600 placeholder:text-gray-400 w-full min-w-0 text-sm sm:text-base"
              />
            </div>
          </div>

          {/* View Toggle */}
          <div className="flex shrink-0 bg-[#E5EDFF] rounded-4xl p-1">
            <button
