...
const EventBanner = () => {
    return (
        <div className="bg-gradient-to-r from-blue-600 to-blue-400 rounded-2xl p-5 lg:p-8 text-white mb-5 relative overflow-hidden shadow-lg">
            ...
            <div className="relative z-10 max-w-2xl">
                <h1 className="lg:text-3xl text-xl font-semibold lg:font-bold mb-4">
                    Ikut Event, Buktikan Kemampuan,
                    <br />
                    dan Dapatkan Reward!
                </h1>
                <p className="text-blue-50 lg:text-lg text-sm leading-relaxed">
