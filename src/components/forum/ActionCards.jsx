        ...
        <section className="mb-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="h-23 rounded-xl px-5 py-3 bg-gradient-to-br from-[#4F86F7] to-[#4578E6] text-white shadow-lg shadow-blue-500/20 relative overflow-hidden group cursor-pointer transition-transform hover:-translate-y-1">
                    ...
                    <div className="absolute left-63 -bottom-12 w-24 h-24 border-10 border-white/13 rounded-full pointer-events-none flex items-center justify-center transition-all duration-500 ease-out group-hover:translate-x-3 group-hover:-translate-y-2 group-hover:scale-105">
                        <div className="w-15 h-15 border-10 border-white/20 rounded-full transition-all duration-500 ease-out group-hover:-rotate-90"></div>
                    </div>
                    <div className="relative z-10 flex flex-row justify-between h-full">
                ...
                <div className="h-23 rounded-xl px-5 py-3 bg-gradient-to-br from-[#7AA0FA] to-[#688DEB] text-white shadow-lg shadow-blue-500/20 relative overflow-hidden group cursor-pointer transition-transform hover:-translate-y-1">
                    <div className="absolute right-63 -top-14 w-24 h-24 bg-white/20 rounded-full pointer-events-none transition-all duration-500 ease-out group-hover:-translate-x-3 group-hover:-translate-y-2 group-hover:scale-110"></div>
