...
const ForumSuggestions = () => {
    const suggestions = [
        ...
        { id: 4, name: 'Pejuang JLPT', members: '1.110', color: 'bg-blue-300' },
        { id: 5, name: 'Late-night finds', members: '3.102', color: 'bg-blue-900' },
    ];

    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-6">
            <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-gray-800 text-lg">Saran Forum</h3>
...
const RelatedTopics = () => {
    ...
    return (
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-gray-800 text-lg">Topik Relate</h3>
                <button className="text-blue-500 text-xs font-medium hover:underline">Segarkan ↻</button>
            </div>
            <div className="divide-y divide-gray-100">
                {topics.map((topic) => (
                    <div key={topic.id} className="py-3 first:pt-0 last:pb-0 hover:bg-gray-50 p-2 rounded-lg transition-colors cursor-pointer">
